  ...
  const handleDelete = async () => {
    ...
    toast.custom((t) => (
      <div className="bg-white p-4 rounded-lg shadow-lg max-w-sm">
        ...
        <p className="text-gray-700 mb-4">¿Estás seguro de eliminar el permiso de {apellidos}?</p>
  ...
  const executeDelete = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Aquí necesitarías actualizar la lista de registros
        // Esto lo manejaremos en el siguiente paso
